...
test("ZERMATT Release-1 Payroll activation and Nigeria compliance gate", () => {
  ...
  requireText(approvalCompliance, ["validateNigeriaPayrollApproval","PAYROLL_APPROVABLE_WITH_STATUTORY_REMITTANCE_WITHHOLDING","approvalBlocked: false","withheldEmployeeIdsByType","taxIdentificationNumber","payeState","pensionPfa","pensionPin"], "Nigeria payroll approval/remittance compliance");
  ...
  const payrollBlockEnd = sidebar.slice(payrollBlockStart + 1).search(/id:\s*"compensation"/) + payrollBlockStart + 1;
