...
function normalizeEpisode(
  ...
  return {
    ...
    startDepartment:
      episode.startDepartment,

    endDepartment:
      episode.endDepartment,

    startDesignation:
      episode.startDesignation,

    endDesignation:
      episode.endDesignation,

    startLocation:
      episode.startLocation,
