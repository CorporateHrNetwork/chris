...
const STATUTORY_AREAS = {
  "/statutories/paye-tax": "PAYE_TAX", "/statutories/pension-compliance": "PENSION_COMPLIANCE", "/statutories/nhia": "NHIA", "/statutories/nsitf": "NSITF", "/statutories/itf": "ITF", "/statutories/remittances": "REMITTANCES", "/statutories/reports": "REPORTS",
};
const PERFORMANCE_AREAS = {
  "/performance/goals-kpis":"GOALS_KPIS", "/performance/cycles":"CYCLES", "/performance/reviews":"REVIEWS", "/performance/appraisals":"APPRAISALS", "/performance/improvement-plans":"IMPROVEMENT_PLANS", "/performance/reports":"REPORTS",
};
const ASSET_AREAS = {
  "/assets/register":"REGISTER", "/assets/categories":"CATEGORIES", "/assets/assignment":"ASSIGNMENT", "/assets/transfers":"TRANSFERS", "/assets/returns":"RETURNS", "/assets/maintenance":"MAINTENANCE", "/assets/reports":"REPORTS",
};
const WORKFLOW_AREAS = {
  "/workflows/approval-inbox":"APPROVAL_INBOX", "/workflows/my-requests":"MY_REQUESTS", "/workflows/templates":"TEMPLATES", "/workflows/approval-chains":"APPROVAL_CHAINS", "/workflows/delegations":"DELEGATIONS", "/workflows/history":"HISTORY",
};
const TRAINING_AREAS = {
  "/training/programs":"PROGRAMS", "/training/calendar":"CALENDAR", "/training/employee-training":"EMPLOYEE_TRAINING", "/training/learning-records":"LEARNING_RECORDS", "/training/assessments":"ASSESSMENTS", "/training/certifications":"CERTIFICATIONS", "/training/reports":"REPORTS",
};
const REPORT_AREAS = {
  "/reports/recruitment":"RECRUITMENT", "/reports/compensation":"COMPENSATION", "/reports/benefits":"BENEFITS", "/reports/custom":"CUSTOM",
};
