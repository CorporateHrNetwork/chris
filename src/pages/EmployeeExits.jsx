...
function printExitSettlementDocument() {
  ...
  const printCss = [
    ...
    ".exit-settlement-print-meta{position:relative;z-index:3;display:grid!important;grid-template-columns:repeat(3,minmax(0,1fr))!important;column-gap:16px!important;row-gap:0!important;padding:2px 0 3px!important;margin-bottom:4px!important;border:0!important;border-bottom:1px solid #c7cec9!important;border-radius:0!important;break-inside:auto!important;page-break-inside:auto!important}",
    ".exit-settlement-print-meta>div{display:grid!important;grid-template-columns:130px minmax(0,1fr)!important;gap:5px!important;align-items:baseline!important;min-width:0!important;padding:0 0 1px!important;border-bottom:1px solid #e0ddd2!important}",
    ".exit-settlement-print-meta span,.exit-settlement-print-totals span,.exit-settlement-headhr-signature-grid span,.exit-settlement-sign-line span{color:#64748b!important;font-size:12pt!important;font-weight:700!important;text-transform:uppercase!important;letter-spacing:0!important;line-height:1.05!important}",
    ".exit-settlement-print-meta strong,.exit-settlement-headhr-signature-grid strong{color:#17211c!important;font-size:12pt!important;font-weight:700!important;line-height:1.05!important;overflow-wrap:anywhere!important}",
    ...
    ".exit-settlement-print-table-section th,.exit-settlement-print-table-section td{padding:1px 4px!important;border:0!important;border-bottom:1px solid #d6d8d5!important;color:#17211c!important;font-size:12pt!important;line-height:1.05!important;overflow-wrap:anywhere!important}",
    ".exit-settlement-print-table-section th{padding-top:1px!important;color:#064e3b!important;font-weight:900!important;text-align:left!important;text-transform:uppercase!important;letter-spacing:.02em!important;border-bottom:1px solid #8fa79a!important}",
    ...
    ".exit-settlement-print-calculation-grid{display:grid!important;grid-template-columns:repeat(4,minmax(0,1fr))!important;column-gap:10px!important;row-gap:0!important;color:#17211c!important;font-size:12pt!important;line-height:1.05!important}.exit-settlement-print-calculation-grid>div{padding:0!important;border-bottom:1px dotted #d6d8d5!important;break-inside:avoid!important}",
    ...
    ".exit-settlement-headhr-signature-grid{display:grid!important;grid-template-columns:repeat(2,minmax(0,1fr))!important;gap:2px 10px!important;align-items:end!important}",
    ".exit-settlement-headhr-signature-grid>div{display:grid!important;gap:1px!important;padding:0!important;border:0!important;min-height:20px!important}",
    ".exit-settlement-headhr-signature-line{height:8px!important;border-bottom:1px solid #475569!important}",
    ...
    "",
    "",
    ".chris-print-report-footer{position:fixed!important;left:0!important;right:0!important;bottom:0!important;z-index:3!important;display:flex!important;align-items:center!important;justify-content:space-between!important;gap:10px!important;margin-top:0!important;padding-top:2px!important;border-top:1px solid #94a3b8!important;color:#64748b!important;font-size:12pt!important;break-before:avoid!important}",
