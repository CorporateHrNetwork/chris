...
const MENU_GROUPS = [
  ...
  },
  {
    ...
    children: [
      ...
      { label: "Applicant Tracking System", path: "/recruitment/ats" },
  ...
  },
  {
    ...
    adminOnly: true,
    children: [
      { label: "Statutory Dashboard", path: "/statutories" },
      { label: "PAYE / Tax", path: "/statutories/paye-tax" },
      { label: "Pension Compliance", path: "/statutories/pension-compliance" },
      { label: "NHIA", path: "/statutories/nhia" },
      { label: "NSITF", path: "/statutories/nsitf" },
      { label: "ITF", path: "/statutories/itf" },
      { label: "Remittances", path: "/statutories/remittances" },
      { label: "Statutory Reports", path: "/statutories/reports" },
    ],
  },
  {
    id: "performance",
    ...
    children: [
      ...
      { label: "Goals / KPIs", path: "/performance/goals-kpis" },
      ...
      { label: "Improvement Plans", path: "/performance/improvement-plans" },
      { label: "Performance Reports", path: "/performance/reports" },
    ],
  },
  {
    id: "training",
  ...
  },
  {
    ...
    adminOnly: true,
    children: [
      { label: "Documents Dashboard", path: "/documents" },
      { label: "Employee Documents", path: "/documents/employee" },
      { label: "HR Documents", path: "/documents/hr" },
      { label: "Company Policies", path: "/documents/policies" },
      { label: "Templates", path: "/documents/templates" },
      { label: "Document Categories", path: "/documents/categories" },
      { label: "Expiry Tracking", path: "/documents/expiry-tracking" },
      { label: "Document Requests", path: "/documents/requests" },
    ],
  },
  {
    id: "reports",
